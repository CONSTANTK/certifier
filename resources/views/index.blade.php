 ...
 <script type="text/javascript">
  ...
  $("button").text("☰");      
    ...
    <div class="panel panel-heading" align="center"><h6 style="font-size:20px"><b>  
                    ...
                    This is the first ever certificate verifying app in Ghana. Over the years, Ghana has been bedeviled with issues of fake certificates.<br>
                    This problem cuts across from educational certificates through business certificates and even certificates on food items, beverages <br> and drugs.

    <div class="panel panel-header">
    <H6 align="center" style="color:red;" >Welcome to CERTFIER</title></H6>
        </i>
