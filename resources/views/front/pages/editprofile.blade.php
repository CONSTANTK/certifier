	...
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				...
				<h5 class="user-name">Mike-Berg Sitsofe Afu</h5>
				<h6 class="user-email">berg@certifier.com</h6>
			</div>
			<div class="about">
				<h5>About</h5>
				<p>I'm Mike, a Software Engineer.</p>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="middleName" placeholder="Enter middle name(s)">
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="birthDate">Date of Birth</label>
					<input type="Date" class="form-control" id="birthDate" placeholder="Enter Date of birth">
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="text-right">
					...
					<button type="button" id="submit" name="submit" class="btn btn-primary"><a href="{{route('front.profile')}}"> Update</a></button>
				</div>
			</div>
		</div>
	</div>
