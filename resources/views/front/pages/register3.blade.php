        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase" style="color:white"><a href="{{route('front.register3')}}">Register</a></h2>
              <p class="text-white-50 mb-5" style="color:green">Please enter user information!</p>

              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" />
                <label class="form-label" for="typeUserIdX">Institution ID </label>
              </div>
              <div class="form-outline form-white mb-4">
              ...
              <button class="btn btn-outline-light btn-lg px-5" type="submit"><a href="{{route('front.register3')}}">Register</a></button>
