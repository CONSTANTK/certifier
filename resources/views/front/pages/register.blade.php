...
@section('content')
                        ...
                        <div class="hero-cap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="front.pages.register">Register</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <section class="contact-section">
                                ...
                                <a target="_blank" rel="noopener"
                                   ...
                                   style="position: static; overflow: visible; float: none; display: inline;">
                                    <div style="width: 66px; height: 26px; cursor: pointer;"><img alt=""
                                         src="https://maps.gstatic.com/mapfiles/api-3/images/google_white5.png" draggable="false" style="position: absolute; left: 0px; top: 0px; width: 66px; height: 26px; user-select: none; border: 0px; padding: 0px; margin: 0px;">
                                    </div>
                                </a></div>
       ...
       @csrf
         ...
         <h6 style="font-size:20px"><b>Welcome To CERTFIER</b></h6>

     <h5  align="center" style="color:blue;" style="font-size:20px"><b>USER REGISTRATION</b></h5>


   <div class="form-group" align="center" >
        <label class="control-label col-sm-2" for="fullname" ><b>Full Name :</b><em ></em></label> <br>
        ...
        <br>
        <div class="col-sm-8" align="center" >            
            <input type="text" name="instID" size="50" id="Institution id=" required="true" class="form-control" value="Enter name of institution" /> 
        </div>
        <br>
        <div class="form-group" align="center">
  ...
  <button type="submit" class="button button-registerForm boxed-btn">Register</button>
 </div>           
  ...
  <div <a href="#" data-toggle="tooltip" title="Click to Register!"></DIV>
    ...
    <br>
      ...
      <input  name="button"  style="color:GREEN"  type="Submit" size="40" font-style="bold" size="40" value="REGISTER" onClick="" <br><br><br>  
       Already registered?<a href='{!! url('user_login'); !!}'>Click here to login</a>       
              <i>
        <H4 align="center" style="color:red;">Welcome to CERTFIER</title></H4>
        </i>
