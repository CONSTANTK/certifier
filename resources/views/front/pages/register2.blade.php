                        ...
                        <div class="hero-cap">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('front.register2')}}">Register</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                ...
                                <div class="gmnoprint" controlwidth="40" controlheight="20"
                                    ...
                                    <div style="width: 40px; height: 10px;">
                                        <button draggable="false" title="Rotate map 90 degrees"
                                                ...
                                                style="background: none rgb(255, 255, 255); display: none; border: 0px; margin: 0px 0px 32px; padding: 0px; position: relative; cursor: pointer; user-select: none; width: 40px; height: 10px; top: 0px; left: 0px; overflow: hidden; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; border-radius: 2px;">
                                            <img src="data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2222%22%20viewBox%3D%220%200%2024%2022%22%3E%0A%20%20%3Cpath%20fill%3D%22%23666%22%20fill-rule%3D%22evenodd%22%20d%3D%22M20%2010c0-5.52-4.48-10-10-10s-10%204.48-10%2010v5h5v-5c0-2.76%202.24-5%205-5s5%202.24%205%205v5h-4l6.5%207%206.5-7h-4v-5z%22%20clip-rule%3D%22evenodd%22%2F%3E%0A%3C%2Fsvg%3E%0A"
                                                 style="height: 10px; width: 18px;"><img
                                        ...
                                        <button draggable="false" title="Tilt map" aria-label="Tilt map" type="button"
                                                ...
                                                style="background: none rgb(255, 255, 255); display: block; border: 0px; margin: 0px; padding: 0px; position: relative; cursor: pointer; user-select: none; width: 40px; height: 20px; top: 0px; left: 0px; overflow: hidden; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; border-radius: 2px;">
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <h2 class="fw-bold mb-2 text-uppercase" style="color:white"><a href="{{route('front.register2')}}">Register</a></h2>
              <p class="text-white-50 mb-5" style="color:green">Please enter institution information!</p>

              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" />
                <label class="form-label" for="typeEmailX">Institution ID </label>
              </div>
              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" />
                <label class="form-label" for="typeEmailX">Institution Name</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="email" id="typeEmailX" class="form-control form-control-lg" />
                <label class="form-label" for="typeEmailX">Institution Type</label>
                </div>
              ...
              <button class="btn btn-outline-light btn-lg px-5" type="submit"><a href="{{route('front.register')}}">Previous</a></button>

              <button class="btn btn-outline-light btn-lg px-5" type="submit"><a href="{{route('front.register3')}}">Next</a></button>
            ...
            <div>
              <p class="mb-0" style="color:white">Don't have an account? <a href="#!" class="text-white-50 fw-bold">Sign Up</a></p>
            </div>
